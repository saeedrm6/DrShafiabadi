<?php
/*
Plugin Name: بسته سئو حرفه ای 
Plugin URI: http://marketwp.ir/author/pchelper/
Description: بهترین افزونه برای سئو و بهینه سازی وب سایت های وردپرسی <a href="admin.php?page=all-in-one-seo-pack-pro/aioseop_class.php">پنل تنظیمات </a> | <a href="http://www.prostyle.ir/support/" target="_blank">ارسال تیکت پشتیبانی</a>
Version: 2.4.4.1
Author: پرو استایل
Author URI: http://prostyle.ir
...
if ( ! defined( 'AIOSEOP_VERSION' ) ) define( 'AIOSEOP_VERSION', '2.4.4.1' );
global $aioseop_plugin_name;
$aioseop_plugin_name = 'بسته سئوی حرفه ای';
